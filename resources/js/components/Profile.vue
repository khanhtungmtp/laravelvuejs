            ...
            <div class="col-md-12 mt-3">
                <div class="card card-widget widget-user">
                    ...
                    <div class="widget-user-header text-white"
                         style="background-image:url('https://picsum.photos/id/237/1000/600')">
...
<script>
    export default {
        ...
        methods: {
            ...
            updateProfile(e) {
                // convert image to base64 use javascript
                // chứa các thuộc tín của file như name,size,type
                ...
                if (file['size'] < limit) {
                    reader.onloadend = (file) => {
                        // render.result là 1 chuỗi kết quả đã convert base64
                        this.form.photo = reader.result;
                    }
                    // method readAsDataUrl , Bắt đầu đọc nội dung của blobOrFile, một khi hoàn thành, fileReader.result sẽ là một URL đại diện cho dữ liệu đọc được.
                    reader.readAsDataURL(file);
                } else {
                    swal.fire({
                        type: 'error',
                        title: 'Oops...',
                        text: 'You are uploading a large file >2MB',
                    })
                    return false;
                }
